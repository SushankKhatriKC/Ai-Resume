        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                with st.spinner('Fetching job recommendations...'):
                    ...
                    for query in queries[:6]:  # Limit to 3 queries to avoid too many requests
                        try:
                            # Get global jobs
                    ...
                    if main_job_title == 'data scientist':
                        ...
                        upwork_job = {
                            'title': 'Data Analyst',
                            'company': 'Asseti Holdings',
                            'location': 'Tripureshwor, Kathmandu,Nepal',
                            'link': 'https://merojob.com/data-analyst-49/',
                        ...
                        linkedin_job = {
                            ...
                            'company': 'Bixal',
                            'location': 'Remote',
                            'link': 'https://www.indeed.com/viewjob?jk=e77e26766c7da759&tk=1j1e0gqc6goos82n&from=serp&vjs=3',
                    
                        }
                        indeed_job = {
                            'title': 'Data Scientist',
                            'company': 'Ford Motor Comapny',
                            'location': '3251 Hillview Avenue, Palo Alto, CA 94305',
                            'link': 'https://www.indeed.com/viewjob?jk=d6d77f8dcda811b5&tk=1j1e0gqc6goos82n&from=serp&vjs=3',
                    ...
                    elif main_job_title == 'prashant bohara':
                        filtered_jobs = [job for job in combined_jobs if "prashant bohara" in job['title'].lower()]
                        upwork_job = {
                        ...
                        indeed = {
                            ...
                            'location': '3009 Annandale Rd, Falls Church, VA 2204',
                            'link': 'https://www.indeed.com/viewjob?jk=d693a3d0f3196812&tk=1j1e57jg5ggn7868&from=serp&vjs=3',
                        
                        }
                        job1 = {
                            'title': 'WordPress Web Developerr',
